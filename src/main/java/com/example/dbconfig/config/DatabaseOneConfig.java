package com.example.dbconfig.config;
...
public class DatabaseOneConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "com.example.dbconfig.repository.dbone";
    public static final String ENTITY_PACKAGE = "com.example.dbconfig.entity.dbone";
